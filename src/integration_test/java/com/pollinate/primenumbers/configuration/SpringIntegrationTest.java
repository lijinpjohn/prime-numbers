...
@SpringBootTest(classes = PrimeNumberApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
public class SpringIntegrationTest {
    ...
    protected String getEndPoint(String uri){
        return TestApplicationConstants.ENDPOINT+uri;
    }
